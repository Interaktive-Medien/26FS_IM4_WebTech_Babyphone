...
| # | Thema | Link |
|---|-------|------|
| 00 | Was ist PHP? | [00-was-ist-php.md](./cheatsheets/00-was-ist-php.md) |
| 01 | Variablen & Datentypen | [01-variablen.md](./cheatsheets/01-variablen.md) |
| 02 | Arrays | [02-arrays.md](./cheatsheets/02-arrays.md) |
| 03 | Bedingungen | [03-bedingungen.md](./cheatsheets/03-bedingungen.md) |
| 04 | POST & GET – Daten empfangen | [04-post-get.md](./cheatsheets/04-post-get.md) |
| 05 | PDO – Datenbankverbindung | [05-pdo-datenbankverbindung.md](./cheatsheets/05-pdo-datenbankverbindung.md) |
| 06 | SQL – Daten lesen (SELECT) | [06-sql-lesen.md](./cheatsheets/06-sql-lesen.md) |
| 07 | SQL – Daten schreiben (INSERT, UPDATE, DELETE) | [07-sql-schreiben.md](./cheatsheets/07-sql-schreiben.md) |
| 08 | JSON in PHP | [08-json.md](./cheatsheets/08-json.md) |
| 09 | Sessions | [09-sessions.md](./cheatsheets/09-sessions.md) |
| 10 | Passwort-Hashing | [10-passwort-hashing.md](./cheatsheets/10-passwort-hashing.md) |
| 11 | API-Endpunkt bauen | [11-api-endpunkt-bauen.md](./cheatsheets/11-api-endpunkt-bauen.md) |
